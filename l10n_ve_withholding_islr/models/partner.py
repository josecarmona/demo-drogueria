...
class ResPartner(models.Model):
    ...
    islr_withholding_agent = fields.Boolean(
            '¿Es agente de retención de ingresos?', default=True,
 ...
 #         'islr.wh.historical.data', 'partner_id', 'Datos históricos de ISLR',
  #        help='Valores a utilizar al calcular las tasas')
    purchase_islr_journal_id = fields.Many2one('account.journal', 'Diario de Compra')
    sale_islr_journal_id = fields.Many2one('account.journal', 'Diario de Venta')
