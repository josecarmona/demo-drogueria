...
class ResPartner(models.Model):
    ...
    consolidate_vat_wh = fields.Boolean(
        'Consolidar Semana de Retencion de IVA',
    ...
    wh_iva_agent = fields.Boolean(
        ...
        help="Indique si el cliente es un agente de retención de IVA", )

    wh_iva_rate = fields.Float(
        string='Tasa de retención de IVA',
        help="Se coloca el porcentaje de la Tasa de retención de IVA" ,required="True")
    ...
    purchase_journal_id = fields.Many2one('account.journal','Diario de Compra')
    purchase_sales_id = fields.Many2one('account.journal', 'Diario de Venta')
