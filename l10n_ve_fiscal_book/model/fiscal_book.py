...
class FiscalBook(models.Model):
   ...
   # company_id = fields.Many2one('res.company', 'Compañia', help='Company', )
    ...
    def update_book_wh_iva_lines(self, fb_id):
        ...
        print("FISCAL_BOOK EN LA LINEA 854")
  ...
  #          for iwdl_brw in iwdl_ids:
        ...
        if inv_iva:
                ...
                for iwdl_brw in iwdl_ids:
                        ...
                        if (self.get_doc_type(inv_id=iwdl_brw.invoice_id.id, iwdl_id=iwdl_brw.id) == 'N/C') :
                            if iwdl_brw.invoice_id.reversed_entry_id:
                            ...
                            debit_codicional=''
                        elif iwdl_brw.invoice_id.debit_origin_id:
                        ...
                        values = {
                                    ...
                                    'invoice_number': iwdl_brw.invoice_id.supplier_invoice_number or "", 
                                    'ctrl_number': iwdl_brw.invoice_id.nro_ctrl or "", 
        ...
        for inv_otro in inv_siva:
                ...
                values = {
                    ...
                    'emission_date':(inv_otro.date or inv_otro.invoice_date) or False,
                    'accounting_date':inv_otro.invoice_date or False,
        ...
        for fbl in fiscal_book.fbl_ids:
            ...
            if fbl.iwdl_id.invoice_id:
                ...
                if fbl.doc_type == 'N/CR' or fbl.doc_type == 'N/DB':
                    ...
                    sign = 1
                sum_base_imponible = 0
                amount_field_data = {'total_with_iva': 0.0,
                                     'vat_sdcf': 0.0, 
                                     'vat_exempt': 0.0, 
